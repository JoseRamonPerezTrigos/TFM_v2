--io.stderr:write("file_magic.lua loaded\n")
...
file_magic =
{
    ...
    { type = 'PPTX', id = 329, category = 'Office Documents,Dynamic Analysis Capable,Local Malware Analysis Capable', msg = 'Microsoft Office Open XML Format (OOXML) Document (PPTX)', rev = 1, magic = { { content = '| 50 4B 03 04 |', offset = 0, }, { content = '| 70 70 74 2F |', offset = 30, }, }, },
    { type = 'DOCX', id = 330, category = 'Office Documents,Dynamic Analysis Capable,Local Malware Analysis Capable', msg = 'Microsoft Office Open XML Format (OOXML) Document (DOCX)', rev = 1, magic = { { content = '| 50 4B 03 04 |', offset = 0, }, { content = '| 77 6F 72 64 2F |', offset = 30, }, }, },
    { type = 'XLSX', id = 331, category = 'Office Documents,Dynamic Analysis Capable,Local Malware Analysis Capable', msg = 'Microsoft Office Open XML Format (OOXML) Document (XLSX)', rev = 1, magic = { { content = '| 50 4B 03 04 |', offset = 0, }, { content = '| 78 6c 2F |', offset = 30, }, }, },
    { type = 'NEW_OFFICE', id = 326, category = 'Office Documents,Dynamic Analysis Capable,Local Malware Analysis Capable', msg = 'Microsoft Office Open XML Format (OOXML) Document (DOCX, PPTX, XLSX)', rev = 1, magic = { { content = '| 50 4B 03 04 |', offset = 0, }, { content = '| 5B 43 6F 6E 74 65 6E 74 5F 54 79 70 65 73 5D 2E |', offset = 30, }, }, },
    { type = 'NEW_OFFICE', id = 327, category = 'Office Documents,Dynamic Analysis Capable,Local Malware Analysis Capable', msg = 'Microsoft Office Open XML Format (OOXML) Document (DOCX, PPTX, XLSX)', rev = 1, magic = { { content = '| 50 4B 03 04 |', offset = 0, }, { content = '| 5F 72 65 6C 73 2F |', offset = 30, }, }, },
    { type = 'NEW_OFFICE', id = 328, category = 'Office Documents,Dynamic Analysis Capable,Local Malware Analysis Capable', msg = 'Microsoft Office Open XML Format (OOXML) Document (DOCX, PPTX, XLSX)', rev = 1, magic = { { content = '| 50 4B 03 04 |', offset = 0, }, { content = '| 64 6F 63 50 72 6F 70 73 2F |', offset = 30, }, }, },
    { type = 'NEW_OFFICE', id = 120, category = 'Office Documents,Dynamic Analysis Capable,Local Malware Analysis Capable', msg = 'Microsoft Office Open XML Format (OOXML) Document (DOCX, PPTX, XLSX)', rev = 1, magic = { { content = '| 50 4B 03 04 |', offset = 0, }, { content = '| 63 75 73 74 6F 6D 58 6D 6C 2F |', offset = 30, }, }, },
    { type = 'NEW_OFFICE', id = 332, category = 'Office Documents,Dynamic Analysis Capable,Local Malware Analysis Capable', msg = 'Microsoft Office Open XML Format (OOXML) Document (DOCX, PPTX, XLSX)', rev = 1, magic = { { content = '| 50 4B 03 04 |', offset = 0, }, { content = '| 76 65 72 61 2F |', offset = 30, }, }, },
}
